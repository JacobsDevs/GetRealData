...
RSpec.describe Property, type: :model do
	before(:each) do
		...
		@prop = @burb.properties.create!(address: '1 Test st, Test', price: "$ 1,000,000 to $900,000")
		@prop2 = @burb.properties.create!(address: '1 Test st, Test', price: "Offers over $ 1,000,000")
	...
	it 'can process_price' do
		@prop.process_price
		@prop2.process_price

		expect(@prop.low_price).to eq(900000)
		expect(@prop.high_price).to eq(1000000)
		expect(@prop2.single_price).to eq(1000000)
	end
end